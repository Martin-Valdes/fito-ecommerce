...
import { ProgressiveWord } from "../ProgressiveWords/ProgressiveWords.jsx";

import "./HomeContainer.scss";

const HomeContainer = () => {
  const img = [
    "1_BIG_ONE_FAMILIA.webp",
    "1_PK_13-14_FAMILIA.webp",
    "1_TOP_BUD_FAMILIA.webp",
    "A30105_Jsr4DId.webp",
    "A30111_0LRYeMa - copia.webp",
    "A30186_mLwe0JX.webp",
    "A31053_hwdHCyM.webp",
    "A33901.webp",
    "A33902.webp",
    ...
    "desmo acrilico.webp",
    "desmo calavera.webp",
    "desmo metal spiderman.webp",
    "desmo metalico 4 partes.webp",
    "desmo para hash.webp",
    "desmo pikachu.webp",
    "desmo tainer.webp",
    "mini bong tornasolado.webp",
    "pipa turbina.webp",
    "supermagro.webp",
    "top paf para botellas en grl.webp",
  ];
    ...
    <div className="homeContainer">
      <div className="containerBack">
        <section className="backVideo">
          ...
          <section className="mayoristContainer">
            <div className="wordContainer">
              <ProgressiveWord
                word="Ventas Mayoristas De Nuestros Productos"
                speed={100}
              />
            </div>
          </section>
      ...
      <section className="categoryContainerProducts">
        <div className="imgContainer">
          <img src="../../img/oil.png" alt="" />
          <h4>Aceite medicinal</h4>
          <p>
            El aceite de cannabis, especialmente el que contiene CBD, ofrece
            numerosos beneficios medicinales gracias a sus propiedades
            antiinflamatorias, analgésicas y neuroprotectoras. Es utilizado para
            aliviar el dolor crónico, reducir la inflamación, y mejorar el
            sueño. Además, ayuda a disminuir la ansiedad y el estrés, aportando
            una sensación de calma sin efectos psicoactivos.
          </p>
        </div>
        <div className="imgContainer">
          ...
          <p>
            ...
            crónico, reducir la ansiedad y el estrés, mejorar el sueño y
            estimular el apetito. También posee efectos neuroprotectores,
            antiespasmódicos y ayuda a mitigar náuseas y vómitos, especialmente
            en tratamientos médicos como la quimioterapia. Gracias a su
            capacidad para tratar una variedad de síntomas , la flor del
            cannabis se ha convertido en una opción terapéutica natural y
            versátil.
          </p>
        </div>
        <div className="imgContainer">
          ...
          <p>
            ...
            como artritis y tendinitis. Proporciona hidratación profunda,
            combate el envejecimiento de la piel gracias a sus propiedades
            antioxidantes y ayuda en el tratamiento de afecciones cutáneas como
            psoriasis y eczema. También es utilizada por atletas para acelerar
            la recuperación muscular tras el ejercicio.
          </p>
        </div>
      </section>
    </div>
